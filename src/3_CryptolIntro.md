...
Okay, did you think about it? What did you come up with? One way to start
answering questions like that is outside in. By that I mean count how many
elements there are. In this case the length of "hello cryptol" is 13
characters. So, the start of the Cryptol type would be `[13]`. What's the type
of each character? Remember that ASCII characters are 8-bits each, so the rest
of the type is [8]. You can just ask Cryptol:
...
`Cryptol> ` **[1, 3 .. 10]**       // the step here 2 (because 3-1=2)  
`[0x1, 0x3, 0x5, 0x7, 0x9]`  
`Cryptol> ` **[10,9 .. 1]**  
...
ways of manipulating them, called _sequence comprehensions_. The way you write them in Cryptol is based
on mathematical notation, so once you get used to them, you'll know
some advanced math notation, too!
